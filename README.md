...
* **fixtures/data-fixture.ts**: Manages test data injection.
* **fixtures/fake-data-provider.ts**: Generates dynamic mock data for tests.
* **fixtures/test-fixture.ts**: Custom Playwright test hooks and setup.
...
* **Docker Ready**: Easily run tests in isolated containers to avoid environment issues.
...
## Environment Setup
Ensure you have a `.env` file in the root directory. This file is ignored by git (.gitignore) to keep your credentials secure.
